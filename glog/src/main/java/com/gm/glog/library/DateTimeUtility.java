...
public class DateTimeUtility {
    ...
    public static String getCurrentTime() {
        ...
        try {
            ...
            SimpleDateFormat dateFormat = new SimpleDateFormat(HT_DATETIME_FORMAT_1,Locale.getDefault());
//            dateFormat.setTimeZone(TimeZone.getTimeZone(HT_TIMEZONE_UTC));
            currentTime = dateFormat.format(new Date());
        } catch (Exception e) {
            GLog.e(TAG, "Exception while getCurrentTime: " + e);
            currentTime = "";
        }
    ...
    public static String getFormattedTime(Date date) {
        ...
        try {
            ...
            GLog.e(TAG, "Exception while getFormattedTime: " + e);
        }
    ...
    public static Date getFormattedDate(String time) {
        ...
        try {
            ...
            GLog.e(TAG, "Exception while getFormattedDate: " + e);
        }
